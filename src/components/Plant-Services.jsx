...
//         setPlants(response.data.data || []); // Ensure we have an array
//         console.log("Fetched plants:", response.data.data);
//       } catch (error) {
//         console.error("Failed to fetch plants:", error);
//         setPlants([]); // Ensure plants is an empty array on error
//       } finally {
...
//     // Reset default product if no products left
...
//   const handleQuantityChange = (productId, newQuantity) => {
//     setSelectedProducts((prevSelectedProducts) => {
//       // Find the product in the current selected products
//       const productToUpdate = prevSelectedProducts.find(
//         (p) => p.id === productId
//       );

//       // If product not found, return current state
//       if (!productToUpdate) {
//         return prevSelectedProducts;
//       }

//       // Find the original product in plants to get max quantity
//       const originalProduct = plants.find((p) => p.id === productId);

//       // Ensure quantity is between 1 and available stock
//       newQuantity = Math.max(
//         1,
//         Math.min(newQuantity, originalProduct.quantity)
//       );
...
//     // Ensure product and its price exist before calculation
